...
MODEL_DIR_D1 = os.path.join(project_root, os.getenv('INF_MODEL_DIR_D1', 'backend/ml/models/models_inf/models_d1_or_not_inf/version_04212026'))
MODEL_DIR_P4 = os.path.join(project_root, os.getenv('INF_MODEL_DIR_P4', 'backend/ml/models/models_inf/models_p4_or_not_inf/version_04212026'))
