"""Validate PCI tier placement for real P4 catcher commits."""
...
def test_p4_catchers_tier_accuracy(hitter_df):
    players = sample_hitters(hitter_df, tier=POWER_4_D1, pos_group="C", n=100)
